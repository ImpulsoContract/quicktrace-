...
async function syncAll() {
  console.log("--- STARTING BULK SYNC (REAL ENV) ---");
  console.log("Using Database URL:", process.env.quicktrace_POSTGRES_PRISMA_URL ? "SET" : "MISSING");
  console.log("Using Stripe Key:", process.env.STRIPE_SECRET_KEY ? "SET" : "MISSING");
    ...
    for (const client of clients) {
      ...
      try {
        ...
        if (subscription) {
          ...
          console.log(`  Stripe Period End: ${subscription.current_period_end} -> ${nextRenewal.toISOString()}`);
